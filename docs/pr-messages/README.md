...
- `Phase C` (13 May 2026): **Shipped.** Reflected via [`feature/giselle-theme-provider`](https://github.com/AlexRebula/giselle-mui/tree/feature/giselle-theme-provider). `GiselleThemeProvider` — zero-config, `themeOverrides`, full custom `theme` prop; `giselleThemeOptions` new public export; internal `deepMerge` utility; Storybook Giselle theme preset wired (default toolbar entry `🥭 Giselle`, `defaultMode = 'system'`). 862 tests. 6/6 quality gate. PR opened 13 May 2026.
- `Phase D` (target: Jun 2026): Planned after Phase C. No dedicated implementation branch in this index yet. Unblocked by Phase C shipping.
...
- `Phase L` (8 May 2026 – 14 May 2026): Quality infrastructure — PR review workflow formalised 14 May 2026. Per-component `roadmap.md` standard defined. Reflected via chore/refactor branches and `chore/component-roadmap-standard`.

Actual PR timeline in this index (GitHub timestamps):

- First PR opened: 21 Apr 2026 (PR 1)
- Latest PR opened: 14 May 2026 (PR 43)
...
| [`chore/all-components-dod-complete`](https://github.com/AlexRebula/giselle-mui/tree/chore/all-components-dod-complete)                               | 27      | —       | 13 May 2026 (open)      | `Phase L` — Quality infrastructure<br />`Phase E` — Standalone UI primitives                                                                                        | All 16 shipped components → DoD 20/20 · Best practices 13/13<br />`ToggleIconButton` extracted from `CheckIconButton` (new standalone component in MUI Inputs taxonomy)<br />`FaqAccordion` → `FaqSection` rename<br />`CheckIconButton` → `ToggleIconButton` rename<br />Cognitive complexity fix for `Accordion` |
| [`feature/giselle-theme-provider`](https://github.com/AlexRebula/giselle-mui/tree/feature/giselle-theme-provider)                                     | 38      | — (S)   | 13 May 2026 (open)      | `Phase C` — GiselleThemeProvider                                                                                                                                    | `GiselleThemeProvider` — zero-config, `themeOverrides`, full custom `theme` prop<br />`giselleThemeOptions` new public export (`CssVarsThemeOptions`)<br />`deepMerge` internal utility (not exported from barrel)<br />Storybook Giselle theme preset (default `'giselle'` toolbar entry, `🥭 Giselle`)           |
| [`chore/component-roadmap-standard`](https://github.com/AlexRebula/giselle-mui/tree/chore/component-roadmap-standard)                                 | 43      | 9 (S)   | 14 May 2026 (open)      | `Phase L` — Quality infrastructure                                                                                                                                  | Per-component `roadmap.md` standard (cleanup-workflow Step 10b)<br />PR review workflow (`docs/pr-review-workflow.md`) — branch hygiene, PR creation, Copilot review response, fix batch commit<br />Session shorthands `review pr <N>` + `create pr <branch>` in copilot-instructions.md                          |
...
| `Phase C` — GiselleThemeProvider ✅ Done — 13 May 2026                                                                                                                | [`feature/giselle-theme-provider`](https://github.com/AlexRebula/giselle-mui/tree/feature/giselle-theme-provider)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
- PR 38 ([GitHub](https://github.com/AlexRebula/giselle-mui/pull/38)) - [pr-38-giselle-theme-provider/README.md](./pr-38-giselle-theme-provider/README.md)

### [`chore/component-roadmap-standard`](https://github.com/AlexRebula/giselle-mui/tree/chore/component-roadmap-standard)

Quality-infrastructure branch that formalises the per-component `roadmap.md` standard and the end-to-end PR review workflow.
Defines Step 10b in `cleanup-workflow.md` (every standalone component gets its own `roadmap.md`), ships `docs/pr-review-workflow.md` covering the full lifecycle from branch hygiene to branch owner sign-off, and adds the `review pr <N>` and `create pr <branch>` session shorthands to `copilot-instructions.md`.
This is the point where ad-hoc process became repeatable, self-documenting infrastructure.
