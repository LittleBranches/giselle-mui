---
sidebar_label: "PR22 - Refactor component structure 2"
---

**[Merged](https://github.com/AlexRebula/giselle-mui/pull/22)** — [`refactor/structure-and-extract`](https://github.com/AlexRebula/giselle-mui/tree/refactor/structure-and-extract) — 4 May – 4 May 2026
...
A large structural refactor to make the component tree consistently navigable and add a CI-enforced structure gate.
